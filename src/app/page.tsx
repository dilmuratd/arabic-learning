      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 border-y border-amber-200 dark:border-amber-800 px-4 py-3">
        <div className="max-w-3xl mx-auto flex items-start gap-3">
          ...
          <p className="text-sm text-amber-800 dark:text-amber-300">
            <span className="font-semibold">Just a heads up</span> — no class on Tuesday May 26 and Thursday May 28 for Eid ul Adha. We&apos;re back on Tuesday <span className="font-semibold">June 2, in shaa Allah</span>. Eid Mubarak everyone! 🎉
          </p>
        </div>
      </div>
      ...
      <section className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            {/* Transliteration */}
            <p className="text-sm text-muted-foreground italic leading-relaxed text-center" dir="ltr">
