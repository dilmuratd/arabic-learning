          ...
          <div className="space-y-4">
            {lesson.examples.map((ex, i) => (
              <div key={i} className="bg-card border border-border rounded-xl p-5">
                {/* Arabic sentence with color-coded breakdown */}
                <div className="flex flex-wrap items-end justify-center gap-1 mb-4 py-2 direction-rtl">
                  ...
                  {lesson.prepositionList.map((prep, i) => (
                    <tr key={i} className="border-t border-border hover:bg-muted/30 transition-colors">
                      <td className="px-4 py-3">
                        <ArabicText size="md">{prep.arabic}</ArabicText>
                      </td>
                  ...
                  {lesson.conjugationTable.active.map((row, i) => (
                    <tr key={i} className="border-t border-border hover:bg-muted/30 transition-colors">
                      <td className="px-4 py-2.5">
                        <ArabicText size="sm">{row.pronoun}</ArabicText>
                      </td>
                      <td className="px-4 py-2.5">
                        <ArabicText size="md" className="text-primary font-bold">{row.form}</ArabicText>
                      </td>
